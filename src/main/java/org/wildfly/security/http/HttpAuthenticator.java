...
public class HttpAuthenticator {
    ...
    private HttpAuthenticator(final ServerAuthenticationContext serverAuthenticationContext, final HttpExchangeSpi httpExchangeSpi,
    ...
    private class AuthenticationExchange extends HttpServerExchange {
        ...
        private boolean authenticate() throws HttpAuthenticationException {
            List<HttpServerAuthenticationMechanism> authenticationMechanisms = serverAuthenticationContext.createHttpServerAuthenticationMechanisms();
            try {
    ...
    public static class Builder {
        ...
        private ServerAuthenticationContext serverAuthenticationContext;
        ...
        /**
         * Set the {@link ServerAuthenticationContext} to use to obtain the actual {@link HttpServerAuthenticationMechanism} instances based
         * on the configured policy.
         *
         * @param serverAuthenticationContext the {@link ServerAuthenticationContext} with the configured authentication policy.
         * @return the {@link Builder} to allow method call chaining.
         */
        public Builder setServerAuthenticationContext(final ServerAuthenticationContext serverAuthenticationContext) {
            this.serverAuthenticationContext = serverAuthenticationContext;
        ...
        public HttpAuthenticator build() {
            return new HttpAuthenticator(serverAuthenticationContext, httpExchangeSpi, required, ignoreOptionalFailures);
        }
